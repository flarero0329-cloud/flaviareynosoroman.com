[flaviareynosoroman.html](https://github.com/user-attachments/files/26061403/flaviareynosoroman.html)
<!DOCTYPE html>
<html lang="es">
<head>
    <meta charset="UTF-8">
...
[selected-works.html](https://github.com/user-attachments/files/26061506/selected-works.html)
<!DOCTYPE html>
<html lang="es">
<head>
    <meta charset="UTF-8">
    ...
    <style>
        /* Base idéntica a la página principal */
        body {
            margin: 0;
            font-family: 'Helvetica Neue', sans-serif;
            background: white;
...
<main class="content">
    ...
    <img src="ruta/de/imagen1.jpg" alt="Descripción imagen 1">
    <img src="ruta/de/imagen2.jpg" alt="Descripción imagen 2">

    <!-- Texto breve -->
    <p>Este es un espacio para describir brevemente tu proyecto, obra o trabajo. Puedes agregar varios párrafos según necesites.</p>

    <!-- Archivos / Links -->
    <div class="files">
        <a href="archivo1.pdf" target="_blank">Archivo 1</a>
        <a href="archivo2.pdf" target="_blank">Archivo 2</a>
        <a href="https://linkexterno.com" target="_blank">Enlace externo</a>
    </div>
</main>
